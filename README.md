...
- Built several ensemble machine-learning models to determine the most suitable and effective for early diagnosis fo obesity.
- Fine-tuned the hyperparameters of the selected machine learning model.
